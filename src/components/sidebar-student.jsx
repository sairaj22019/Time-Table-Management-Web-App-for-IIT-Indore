// "use client"
// import { Calendar, CalendarDays, ChevronUp, Home, Inbox, Settings, LogOut, UserCog, Route } from "lucide-react"
...
"use client"
import { Calendar, CalendarDays, ChevronUp, Home, Inbox, Settings, LogOut, UserCog, Moon, Sun } from "lucide-react"
import { motion, AnimatePresence } from "framer-motion"
import Link from "next/link"
          ...
          <SidebarMenuItem>
            <DropdownMenu open={isDropdownOpen} onOpenChange={setIsDropdownOpen}>
              <DropdownMenuTrigger asChild >
                <SidebarMenuButton
                  isActive={isDropdownOpen}
                  className="group relative right-1 hover:bg-sidebar-accent/80 transition-all duration-200"
                >
                  <motion.div
                    whileHover={{ scale: 1.05 }}
                    transition={{ duration: 0.2 }}
