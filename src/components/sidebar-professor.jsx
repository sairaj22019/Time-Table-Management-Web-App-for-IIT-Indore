...
const items = [
  { title: "Home", url: "/professor", icon: Home },
  { title: "Inbox", url: "/professor/inbox", icon: Inbox },
  { title: "allCourses", url: "/professor/courses", icon: Calendar },
//   { title: "createcourse", url: "/professor/createcourse", icon: CalendarDays },
  { title: "Settings", url: "/professor/settings", icon: Settings },
]
