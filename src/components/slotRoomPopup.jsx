...
// export default function SlotRoomPopup(props) {
//   const {
//     buttonText = "Add Slot",
...
//                   <p>
//                     Please check if the room and time slot are available before adding to avoid scheduling conflicts, use the features related to room availability and view grids to ensure no clashes with existing schedules.
//                   </p>
//                 </div>
//               </div>
//             </div>
...
//             <Input
//               id="slotName"
//               placeholder="Enter the slot letter from the grid(Eg : A, B)"
//               value={slotName}
