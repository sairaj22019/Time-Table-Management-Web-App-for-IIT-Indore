          ...
          <div className="flex justify-between items-center">
            <motion.div whileHover={{ scale: 1.05 }} className="flex items-center space-x-2">
              <div className="w-8 h-8 bg-gradient-to-r from-blue-500 to-sky-500 rounded-lg flex items-center justify-center">
                {/* Replace Calendar icon with logo image */}
                <Image src="/campussync-logo.svg" alt="CampusSync Logo" width={24} height={24} />
              </div>
            ...
            <div className="hidden md:flex items-center space-x-8 text-gray-600">
              ...
              <Link href="#dashboards" className="hover:text-blue-600 transition-colors">
                Dashboards
              </Link>
            </div>
