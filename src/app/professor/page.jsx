...
const quickActions = [
  ...
  },
  {
    ...
    badge: professorData.unreadMessages,
...
const motivationalCards = [
  {
    ...
    message: "Every lesson is an opportunity to shape the future and ignite curiosity in your students.",
    icon: HiLightBulb,
  ...
  },
  {
    ...
    message: "Your expertise and guidance help students discover their potential and achieve their dreams.",
    icon: HiStar,
  ...
  },
  {
    id: 3,
    title: "Making Impact!",
    message: "Remember that your dedication to teaching creates ripples that extend far beyond the classroom.",
    icon: HiHeart,
