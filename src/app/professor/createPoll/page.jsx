              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4 sm:space-y-6">
                  ...
                  <motion.div variants={itemVariants} className="space-y-4">
                    <div className="flex items-center gap-2">
                      <HiCalendar className="w-5 h-5 text-purple-600" />
                      <h3 className="text-lg font-semibold text-gray-800">Poll Expiry</h3>
                    </div>
                    <div className="p-4 sm:p-6 border-2 border-gray-200 rounded-xl bg-gray-50/50 space-y-4">
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        {/* Expiry Date */}
                        <FormField
                          control={form.control}
                              ...
                              <FormControl>
                                <div className="relative">
                                  ...
                                  <Input
                                    ...
                                    onClick={() => {
                                      // Trigger the hidden date input
                                      const hiddenInput = document.getElementById('expiry-date')
                                      if (hiddenInput) {
                                        hiddenInput.showPicker?.() || hiddenInput.click()
                                      }
                                    }}
