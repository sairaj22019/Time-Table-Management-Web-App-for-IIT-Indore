...
//     ],
//     description: "Advanced concepts in modern web development frameworks and best practices",
...
//     maxCapacity: 55,
//     timings: [
//       { day: "Monday", time: "1:00 PM - 2:30 PM", room: "Room 220" },
//       { day: "Wednesday", time: "1:00 PM - 2:30 PM", room: "Room 220" },
//       { day: "Friday", time: "11:00 AM - 12:30 PM", room: "Lab 201" },
//     ],
...
//     ],
//     description: "Introduction to machine learning algorithms, applications, and practical implementation",
...
//   const [filteredCourses, setFilteredCourses] = useState(professorCoursesData)
...
//     let filtered = professorCoursesData
...
//   const categories = ["all", ...Array.from(new Set(professorCoursesData.map((course) => course.category)))]
...
//                       <Button
//                         onClick={() => handlePoll(course.id, course.name)}
//                         size="sm"
...
//                       </Button>
//                       <Button
//                         onClick={() => handleMessage(course.id, course.name)}
//                         size="sm"
...
//                         className="space-y-5"
//                       >
//                         {/* Course Stats - Only Student Count */}
...
//                         >
//                           <div className="p-2 bg-white rounded-lg shadow-sm">
//                             <HiClock className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-gray-600" />
//                           </div>
//                           <div>
//                             <p className="text-sm sm:text-base font-medium text-gray-800">
//                               {course.lecturesPerWeek} lectures per week
//                             </p>
//                             <p className="text-xs sm:text-sm text-gray-500">Next: {course.nextClass}</p>
//                           </div>
//                         </motion.div>
...
//                                   <div>
//                                     <span className="font-medium text-gray-800 text-sm sm:text-base">{timing.day}</span>
//                                     <p className="text-xs sm:text-sm text-gray-500">{timing.time}</p>
//                                   </div>
//                                 </div>
