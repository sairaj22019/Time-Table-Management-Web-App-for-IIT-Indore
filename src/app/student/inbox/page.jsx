...
//     try {
//       const body = { studentEmail: "cse240001029@iiti.ac.in" };
...
//       // You probably want to update state here as well:
//       // setNotifications()
//       // const allNotications=[];
//       // for(const item of data.student){
//       //   allNotications.push(item.notification);
//       // }
//       // setNotifications(allNotications);
//     } catch (error) {
...
//                     ...option,
//                     voteCount: Math.floor(Math.random() * 20), // Since vote count isn't provided in API
//                   })),
//                   course: notification.course.title, // You might need to fetch course details separately
//                   courseCode: notification.course.courseCode, // You might need to fetch course details separately
//                   prof: notification.prof.username, // You might need to fetch professor details separately
//                   reason: notification.message.reason,
//                   context: notification.message.context,
//                   isApproved: notification.message.isApproved,
//                   totalVotes: Math.floor(Math.random() * 50), // Since total votes isn't provided
//                 },
//               }
//             } else {
...
//                   sender: notification.prof.username, // You might need to fetch professor details separately
//                   course: notification.course.title, // You might need to fetch course details separately
//                   courseCode: notification.course.courseCode, // You might need to fetch course details separately
//                 },
//               }
