...
export default function LoginPage() {
  ...
  const handleGoogleLogin = () => {
    signIn("google", { callbackUrl: "/profile" }).catch(() => setErrorMsg("Failed to sign in with Google."))
  }
        ...
        <Card className="shadow-xl rounded-2xl border border-gray-100 bg-white/80 backdrop-blur-md">
          <CardContent className="py-10 px-8">
                    ...
                    <FormItem>
                      ...
                      >
                        <div className="relative">
                          ...
                          <Input type="email" placeholder="name@iit.ac.in" className="pl-10" {...field} />
                        </div>
                      </motion.div>
                      <FormMessage />
                    </FormItem>
            ...
            <Button
              type="button"
              variant="outline"
              className="w-full flex items-center justify-center gap-3 text-gray-700 font-medium border border-gray-300 hover:bg-gray-100 bg-transparent"
