...
//     },
//     {
//       message: "Slots are required for students in year 2 and above",
//       path: ["slots"],
//     },
//   )
...
//         setSlotError(`Invalid slots (must be single letters): ${invalidSlots.join(", ")}`)
//         return
//       }
...
//     // Check slots for year > 1
//     if (Number.parseInt(data.year) > 1 && (!data.slots || data.slots.length === 0)) {
//       requiredFields.push({ field: false, name: "Slots (required for year 2 and above)" })
//     }
...
//         slots: Number.parseInt(data.year) > 1 ? data.slots || [] : [], // Send empty array for year 1
//         students: {
//           departments: data.selectedDepartments,
//           year: data.year,
//           rollnos: data.rollNumbers || [],
...
//                       <div className="space-y-6">
//                         <div className="flex items-center gap-2">
//                           <label className="text-base font-semibold text-gray-700">Time Slots</label>
...
//                         <div className="flex gap-3">
//                           <Input
//                             placeholder="Enter slot letters (comma or space separated) e.g., A, B, C"
//                             value={slotInput}
//                             onChange={(e) => {
...
//       >
//         <Card className="shadow-2xl rounded-3xl border border-gray-100 bg-white/90 backdrop-blur-lg overflow-visible">
//           <CardContent className="py-6 sm:py-12 px-4 sm:px-10 overflow-visible">
//             <div className="flex flex-col items-center justify-between gap-3 mb-6 sm:mb-8">
//               <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4">
//                 <div>
//                   <GraduationCap className="w-8 h-8 sm:w-10 sm:h-10 text-blue-600" />
//                 </div>
//                 <h2 className="text-2xl sm:text-4xl font-bold text-gray-800 text-center">Create New Course</h2>
//               </div>
//               <Link
//                 href="/courses"
//                 className="text-sm text-blue-600 hover:text-blue-800 hover:underline transition-colors"
...
//                       <h4 className="text-lg font-semibold text-gray-800 mb-4">L-T-P-C</h4>
...
//                                     onKeyDown={(e) => handleKeyDown(e, "T")}
//                                   />
//                                   <p className="text-xs text-gray-500 text-center">Lectures</p>
//                                 </div>
//                               </FormControl>
//                             </FormItem>
//                           )}
...
//                                     onKeyDown={(e) => handleKeyDown(e, "P")}
//                                   />
//                                   <p className="text-xs text-gray-500 text-center">Tutorials</p>
//                                 </div>
//                               </FormControl>
//                             </FormItem>
//                           )}
...
//                                     onKeyDown={(e) => handleKeyDown(e, "C")}
//                                   />
//                                   <p className="text-xs text-gray-500 text-center">Practicals</p>
//                                 </div>
//                               </FormControl>
//                             </FormItem>
//                           )}
...
//                                     onKeyDown={(e) => handleKeyDown(e, "courseCoordinator")}
//                                   />
//                                   <p className="text-xs text-gray-500 text-center">Credits</p>
//                                 </div>
//                               </FormControl>
//                             </FormItem>
//                           )}
...
//                         animate={{ opacity: 1, height: "auto" }}
//                         exit={{ opacity: 0, height: 0 }}
//                         className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 p-4 sm:p-6 border-2 border-gray-200 rounded-xl bg-gray-50/50"
//                       >
//                         <FormField
//                           control={form.control}
//                           name={`professors.${index}.name`}
...
//                           </span>
//                         </FormLabel>
//                         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 p-4 sm:p-6 border-2 border-gray-200 rounded-xl bg-gray-50/50 max-h-72 overflow-y-auto">
//                           {departments.map((department) => (
//                             <FormField
//                               key={department}
//                               control={form.control}
...
//                             animate={{ opacity: 1, height: "auto" }}
//                             exit={{ opacity: 0, height: 0 }}
//                             className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 p-4 sm:p-6 border-2 border-gray-200 rounded-xl bg-gray-50/50 overflow-visible"
//                           >
//                             <FormField
//                               control={form.control}
//                               name={`schedule.${index}.day`}
...
//                   animate={{ opacity: 1, y: 0 }}
//                   transition={{ delay: 0.6 }}
//                   className="flex flex-col sm:flex-row gap-4 sm:gap-6 pt-6 sm:pt-8 border-t-2 border-gray-200"
//                 >
//                   <Button
//                     type="submit"
//                     className="flex-1 h-14 bg-blue-600 hover:bg-blue-700 text-white font-bold text-lg transition-all duration-200 shadow-lg hover:shadow-xl"
...
//   .refine(
//     (data) => {
//       // If year > 1, slots with rooms are required
//       if (Number.parseInt(data.year) > 1) {
//         return data.slots && data.slots.length > 0
//       }
//       return true
//     },
//     {
//       message: "Slots with rooms are required for students in year 2 and above",
//       path: ["slots"],
//     },
//   )
...
//   const addSlots = () => {
//     if (slotInput.trim() && roomInput.trim()) {
//       setSlotError("")
//       const currentSlots = form.getValues("slots") || []

//       const newSlot = {
//         slot: slotInput.trim().toUpperCase(),
//         room: capitalizeRoom(roomInput.trim())
//       }

//       // Check if slot already exists
//       const slotExists = currentSlots.some(s => s.slot === newSlot.slot)
...
//       if (!validateSlot(newSlot.slot)) {
//         setSlotError("Invalid slot format")
//         return
//       }
...
//       setRoomInput("")
//     } else {
//       setSlotError("Both slot and room are required")
//     }
//   }
...
//               })) || []
//             : [], // Send empty array for year > 1
//         slots: Number.parseInt(data.year) > 1 ? data.slots?.map(slotData => ({
//           slot: slotData.slot,
//           room: slotData.room
//         })) || [] : [], // Send empty array for year 1
//         students: {
...
//                           <div className="space-y-2">
//                             <label className="text-sm font-semibold text-gray-700">Slot Letter *</label>
//                             <Input
//                               placeholder="Enter slot letter e.g., A, B, C"
//                               value={slotInput}
//                               onChange={(e) => {
//                                 setSlotInput(e.target.value)
//                                 if (slotError) setSlotError("")
...
//                                 {form.watch("slots")?.map((slotData, index) => (
//                                   <motion.div
//                                     key={index}
//                                     initial={{ opacity: 0, scale: 0.8 }}
//                                     animate={{ opacity: 1, scale: 1 }}
//                                     exit={{ opacity: 0, scale: 0.8 }}
//                                     className="flex items-center justify-between bg-blue-100 text-blue-800 px-4 py-3 rounded-lg text-sm font-medium shadow-sm"
//                                   >
//                                     <div className="flex flex-col">
//                                       <span className="font-bold">{slotData.slot}</span>
//                                       <span className="text-xs text-blue-600">{slotData.room}</span>
//                                     </div>
//                                     <button
//                                       type="button"
//                                       onClick={() => removeSlot(index)}
