          ...
          <CardContent className="py-6 sm:py-12 px-4 sm:px-10 overflow-visible">
            <div className="flex flex-col items-center justify-between gap-3 mb-8">
              <div className="flex items-center gap-4">
                ...
                <h2 className="text-2xl sm:text-4xl font-bold text-gray-800">Create New Course</h2>
              </div>
              <Link
                href="/courses"
                className="text-sm text-blue-600 hover:text-blue-800 hover:underline transition-colors"
            ...
            <p className="text-xs sm:text-sm text-gray-600 text-center mb-8 sm:mb-10 max-w-2xl mx-auto px-2">
              Fill in the details below to create a new course for the semester. All required fields must be completed
              before submission.
            </p>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 overflow-visible">
                ...
                >
                  ...
                  {/* Enhanced Semester Fields */}
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 overflow-visible">
                    <FormField
                      control={form.control}
                      name="semesterYear"
                      render={({ field }) => (
                  ...
                  <AnimatePresence>
                    {professorFields.map((field, index) => (
                      <motion.div
                        ...
                        animate={{ opacity: 1, height: "auto" }}
                        exit={{ opacity: 0, height: 0 }}
                        className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 sm:p-6 border-2 border-gray-200 rounded-xl bg-gray-50/50"
                      >
                        <FormField
                          control={form.control}
                          name={`professors.${index}.name`}
                      ...
                      <AnimatePresence>
                        {scheduleFields.map((field, index) => (
                          <motion.div
                            ...
                            animate={{ opacity: 1, height: "auto" }}
                            exit={{ opacity: 0, height: 0 }}
                            className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 p-4 sm:p-6 border-2 border-gray-200 rounded-xl bg-gray-50/50 overflow-visible"
                          >
                            <FormField
                              control={form.control}
                              name={`schedule.${index}.day`}
