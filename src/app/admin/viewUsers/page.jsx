...
// //       { id: 5, name: "Operating Systems", code: "CS305" },
// //       { id: 6, name: "Machine Learning", code: "CS306" },
// //     ],
// //     2: [
// //       // janesmith's enrolled courses
// //       { id: 7, name: "Circuit Analysis", code: "EE201" },
// //       { id: 8, name: "Digital Electronics", code: "EE202" },
// //       { id: 9, name: "Signals and Systems", code: "EE203" },
// //       { id: 10, name: "Control Systems", code: "EE204" },
// //       { id: 11, name: "Power Electronics", code: "EE205" },
// //     ],
// //     3: [
// //       // profwilson's teaching courses
// //       { id: 1, name: "Data Structures and Algorithms", code: "CS301" },
// //       { id: 2, name: "Database Management Systems", code: "CS302" },
// //       { id: 12, name: "Advanced Algorithms", code: "CS401" },
// //     ],
// //     4: [
// //       // profdavis's teaching courses
// //       { id: 13, name: "Calculus I", code: "MATH101" },
// //       { id: 14, name: "Linear Algebra", code: "MATH201" },
// //       { id: 15, name: "Discrete Mathematics", code: "MATH301" },
// //       { id: 16, name: "Statistics", code: "MATH401" },
// //     ],
// //     5: [
// //       // alicejohnson's enrolled courses
// //       { id: 17, name: "Thermodynamics", code: "ME201" },
// //       { id: 18, name: "Fluid Mechanics", code: "ME202" },
// //       { id: 19, name: "Machine Design", code: "ME301" },
// //       { id: 20, name: "Manufacturing Processes", code: "ME302" },
// //     ],
// //   }
...
// //               {selectedUser &&
// //                 mockCourses[selectedUser.id]?.map((course, index) => (
// //                   <motion.div
// //                     key={course.id}
// //                     initial={{ opacity: 0, y: 20 }}
// //                     animate={{ opacity: 1, y: 0 }}
...
// //             {selectedUser && (!mockCourses[selectedUser.id] || mockCourses[selectedUser.id].length === 0) && (
// //               <motion.div
...
//   const handleCourseClick = (courseId) => {
//     router.push(`/admin/courses?courseId=${courseId}`)
//     setShowCoursesModal(false)
//   }

//   // Remove the mockUsers and mockCourses arrays
