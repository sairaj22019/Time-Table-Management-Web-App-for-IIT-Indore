...
// //     try {
// //       // Here you would make an API call to update the department
// //       // const response = await fetch(`/api/admin/updateUserDepartment`, {
// //       //   method: 'PUT',
...
// //             ? { ...user, department: getDepartmentLabel(newDepartment, editingUser.type) }
// //             : user,
// //         ),
// //       )
...
// //         description: `${editingUser.username}'s department has been successfully updated.`,
// //         duration: 3000,
// //       })
// //     } catch (error) {
// //       toast({
...
//       )
//       setShowConfirmationModal(false)
//       toast.success(`${editingUser.username}'s department has been successfully updated.`)
//     } catch (error) {
