...
//   useEffect(() => {
//     if (isEditMode && courseDataParam) {
//       try {
//         const courseData = JSON.parse(decodeURIComponent(courseDataParam))
//         setEditingCourse(courseData)

//         // Parse semester data - handle different formats
//         let semesterYear = ""
//         let duration = ""

//         if (courseData.forSemester) {
//           const semesterParts = courseData.forSemester.split(" ")
//           if (semesterParts.length >= 2) {
//             semesterYear = semesterParts[0]
//             duration = semesterParts[1]
//           }
//         }

//         // Map professor data
//         const professors = []
//         if (courseData.profName && courseData.profEmail) {
//           for (let i = 0; i < Math.max(courseData.profName.length, courseData.profEmail.length); i++) {
//             professors.push({
//               name: courseData.profName[i] || "",
//               email: courseData.profEmail[i] || "",
//             })
//           }
//         }
...
//         // Map departments from abbreviations to full names for display
//         const selectedDepartments = courseData.students?.departments || []
//         console.log("Original departments:", selectedDepartments)

//         // Map schedule data with proper time format
//         const schedule =
//           courseData.schedule?.map((item) => ({
//             day: item.day,
//             startTime: item.start ? item.start.replace(":", " ") : "",
//             endTime: item.end ? item.end.replace(":", " ") : "",
//             room: item.room || "",
//           })) || []
...
//           year: courseData.students?.year?.toString() || courseData.studentYear?.toString() || "",
//           courseCode: courseData.courseCode || "",
//           semesterYear: semesterYear,
//           duration: duration,
//           L: Number(courseData.lectures) || 0,
//           T: Number(courseData.tutorials) || 0,
//           P: Number(courseData.practicals) || 0,
//           C: Number(courseData.credits) || 0,
//           courseCoordinator: courseData.courseCoordinator || "",
//           professors: professors,
//           selectedDepartments: selectedDepartments,
//           rollNumbers: courseData.students?.rollnos || [],
//           schedule: schedule,
...
//         // Force update form values to ensure they're set
//         setTimeout(() => {
...
//         setErrorMsg("Error loading course data for editing")
//       }
//     }
//   }, [isEditMode, courseDataParam, form])
...
//         method = "PUT"
//         endpoint = `/api/admin/courses/${editingCourse.id}`
//       } else {
//         // Create new course
//         if (data.year == 1) {
//           endpoint = "/api/course/createCourseForYear1"
//         } else {
...
//       const result = await response.json()
//       if (!response.ok) {
//         throw new Error(result.message || `Failed to ${isEditMode ? "update" : "create"} course`)
//       }

//       setLoading(false)
//       alert(`Course ${isEditMode ? "updated" : "created"} successfully!`)
//       console.log(`Course ${isEditMode ? "updated" : "created"}:`, result.course)
//       // Redirect to courses page
//       router.push("/admin/courses")
//     } catch (error) {
//       console.error(`Course ${isEditMode ? "update" : "creation"} error:`, error)
//       setErrorMsg(error.message || "Something went wrong. Please try again.")
//       setLoading(false)
//     }
//   }
...
//                 : "Fill in the details below to create a new course for the semester. All required fields must be completed before submission."}
//             </p>
...
//         <DialogContent>
//           <DialogHeader>
//             <DialogTitle>Confirm Course Update</DialogTitle>
//             <DialogDescription>
//               Are you sure you want to update this course? This action will modify the existing course data.
//             </DialogDescription>
//           </DialogHeader>
//           <DialogFooter>
